...
void flight::flight_info(){
	...
	cout<<"\nDeparturetime::"<<setw(5)<<departure_time;
	cout<<"\tArrivaltime::"<<setw(5)<<arrival_time;
...
return ;
	...
	cout<<"\nNopassemger found with this passport number";
}
...
Node2d*ptr,*temp=flt.Ehead;
	...
	cout<<"\nNopassemger has been found with this Travel Passport Number";
}
...
cout<<"\nThere are no flight scheduled to take off.";
                ...
                m1_user:
                choice = 0;
cout<<"\nWelcomeTraveller, what would you like to do? Enter appropriate choice number";
